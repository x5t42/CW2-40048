...
xTrain = X.iloc[:split_index]
yTrain = y.iloc[:split_index]
xTest  = X.iloc[split_index:]
yTest  = y.iloc[split_index:]

rfModel = RandomForestRegressor(n_estimators=25, random_state=42)
...
plt.title('Random Forest: 24-Hours Ahead Gold Price Prediction')
plt.xlabel('Date')
